...
# but with changes to accommodate multiple agents.
...
BUFFER_SIZE = int(1e5)  # replay buffer size # TODO 1e6
BATCH_SIZE = 256        # minibatch size
GAMMA = 0.99            # discount factor
TAU = 1e-3              # for soft update of target parameters
LR_ACTOR = 1e-4         # learning rate of the actor 
LR_CRITIC = 1e-3        # learning rate of the critic # TODO 3e-4
WEIGHT_DECAY = 0        # L2 weight decay # TODO 0.0001
